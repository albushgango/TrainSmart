...
export function parseTCX(xmlString, optionen = {}) {
	...
	const altitudes = alleTrackpoints.map((tp) => tp.altitudeM).filter(Number.isFinite);
	...
	const intervalAnalyse =
		sport === 'Laufen' ? berechneIntervalleAusPunkten(alleTrackpoints) : { intervalle: [] };
