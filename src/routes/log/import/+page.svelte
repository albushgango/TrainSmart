...
<div class="page">
    ...
    {#if !geparsed}
        ...
        <section class="info-card">
            <h2>So gehts</h2>
            <ol>
                <li>Öffne deine Activity in <a href="https://connect.garmin.com" target="_blank" rel="noopener">Garmin Connect</a></li>
            ...
            <p class="hinweis">
                Wird automatisch ausgelesen: Sport, Datum, Dauer, Distanz, Ø HR, Max HR,
                Kalorien, Schrittfrequenz, Watts, Höhenmeter, km-Splits und Verlaufs-Daten.
            </p>
        </section>
    ...
    {:else}
        ...
        <form method="POST" action="?/speichern" use:enhance>
            ...
            <input type="text" id="subtyp" name="subtyp" bind:value={subtyp}
                placeholder="z.B. Easy, Tempo, Long Run" />

            <label for="notiz" class="field-label">Notiz <span class="optional">(optional)</span></label>
            <textarea id="notiz" name="notiz" bind:value={notiz} placeholder="Wie war der Lauf?"></textarea>
...
<style>
    .page { max-width: 480px; margin: 0 auto; padding: 1.75rem 1rem 1rem; }

    header { display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem; }

    h1 {
        font-size: 1.4rem; margin: 0; font-weight: 900; letter-spacing: 0.02em;
        color: var(--text-primary); text-transform: uppercase;
    }

    .back {
        font-size: 1.5rem; text-decoration: none; color: var(--text-primary);
    ...
    .error {
        ...
        padding: 0.85rem; border-radius: var(--radius-sm); margin-bottom: 1rem;
        font-size: 0.9rem;
    }
    ...
    .info-card h2 {
        margin: 0 0 0.7rem; font-size: 1rem; font-weight: 700; color: var(--text-primary);
    }
    ...
    .info-card ol li { margin-bottom: 0.3rem; }
    ...
    .info-card .hinweis {
        margin: 0; padding-top: 0.75rem; border-top: 1px solid var(--border);
        font-size: 0.78rem; color: var(--text-tertiary); line-height: 1.5;
    }
    ...
    .upload-label {
        ...
        border-radius: var(--radius-lg); padding: 2.5rem 1rem;
    ...
    .vorschau-card {
        ...
        border-radius: var(--radius-xl); padding: 1.4rem; margin-bottom: 1.25rem;
    ...
    .vorschau-icon { font-size: 2.2rem; }
    ...
    .vorschau-datum {
        font-size: 0.82rem; color: var(--text-tertiary); margin-top: 0.2rem;
    }
    ...
    .vorschau-item {
        ...
        padding: 0.7rem; background: var(--bg-input); border-radius: var(--radius-sm);
    }
    ...
    .vorschau-meta {
        ...
        font-size: 0.72rem; color: var(--text-tertiary); text-align: center;
    }
    ...
    input[type="text"], textarea {
        ...
        font-size: 1rem; width: 100%; color: var(--text-primary); font-family: inherit;
    }
    ...
    input[type="range"] {
        width: 100%; appearance: none; background: transparent; margin: 0.25rem 0;
    }

    input[type="range"]::-webkit-slider-runnable-track {
        height: 6px; background: var(--bg-card); border: 1px solid var(--border);
        border-radius: 999px;
    }
    input[type="range"]::-webkit-slider-thumb {
        appearance: none; width: 22px; height: 22px; background: var(--accent);
        border-radius: 50%; margin-top: -9px; box-shadow: 0 0 12px var(--accent-glow);
        cursor: pointer;
    }
    ...
    input[type="range"]::-moz-range-thumb {
        ...
        border: none; box-shadow: 0 0 12px var(--accent-glow); cursor: pointer;
    }

    .rpe-skala {
        display: flex; justify-content: space-between;
        font-size: 0.7rem; color: var(--text-tertiary); margin-top: 0.1rem;
        text-transform: uppercase; letter-spacing: 0.05em;
    }

    .btn-save {
        margin-top: 1.5rem; background: var(--cta-bg); color: var(--cta-color);
        padding: 1rem; border: none; border-radius: var(--radius-md);
        font-size: 1rem; font-weight: 700; cursor: pointer; font-family: inherit;
        transition: background 0.15s, transform 0.15s;
    }

    .btn-save:hover { background: var(--cta-bg-hover); transform: translateY(-1px); }

    .cancel {
        text-align: center; color: var(--text-tertiary); font-size: 0.9rem;
        text-decoration: none; margin-top: 0.6rem; padding: 0.5rem;
    }
